          ...
          <div class="card-body">
              <div class="row">
                  ...
                  <div class="col-md-8">
                      ...
                      <hr>
                      <label class="me-3" >Original Price : <s>{{ $products->original_price }} DH</s></label>
                      <label class="fw-bold">Selling Prise :  {{ $products->selling_price }} DH</label>
                      ...
                      <div class="row mt-2">
                        ...
                        <div class="col-md-9">
                            <br/>
                            @if ($products->qty > 0)
                            <button type="button" class="btn btn-primary me-3 addToCart-btn float-start">Add to Cart <i class="fa fa-shopping-cart"></i></button>
                            @endif
